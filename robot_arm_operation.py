...
# 1. CAN 인터페이스 연결
try:
    bus = can.interface.Bus(interface='socketcan', channel='slcan0')  # slcan0 인터페이스 사용
...
# 3. JSON 파일에서 첫 줄 joint_values 읽기
json_file_path = "/home/kkm/joint_states_log.json"

with open(json_file_path, 'r') as f:
    first_line = f.readline()
    joint_data = json.loads(first_line)
    joint_angles = joint_data['joint_values']
